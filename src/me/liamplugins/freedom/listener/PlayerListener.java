package me.liamplugins.freedom.listener;

import java.lang.reflect.Field;
import static me.liamplugins.freedom.core.Freedom.plugin;
...
public class PlayerListener implements Listener {
    ...
    public void OnServerPing(ServerListPingEvent event) {
        ...
        if (plugin.config.getString("motd").contains("%version%"))
        {
            event.setMotd(Util.colorize(plugin.config.getString("motd").replace("%version%", plugin.getVersion())));
        }
